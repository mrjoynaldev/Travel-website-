...
export function StudioAutomations() {
  ...
  const [form, setForm] = useState({ platform: "instagram" as "instagram", post_id: "", post_title: "", keywords: "GUIDE, guide, Link, link", any_comment: false, dm_template: "Hey! Here’s your guide:", button_text: "Read Full Guide", button_url: "https://codereportglobal.indevs.in/articles/", follow_required: true, search: "" });
