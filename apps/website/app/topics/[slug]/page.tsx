...
const GENERIC_FAQS = [
  { q: "What will I find in this hub?", a: "Every published Sundarban Yatri guide on this topic — practical, honest answers written from real trip experience." },
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  try {
    ...
    return {
      title,
      description: category.description || `Sundarban travel guides from Sundarban Yatri on ${category.name}.`,
      alternates: { canonical: `/topics/${category.slug}` },
      openGraph: { type: "website", siteName: "Sundarban Yatri", locale: "en_US", url: `${siteUrl()}/topics/${category.slug}`, title, description: category.description || undefined, images: [{ url: `${siteUrl()}/og-default.png`, width: 1200, height: 630 }] },
