...
import { optimizedImageUrl, responsiveSrcSet } from "@web/lib/social-image";
...
export default function ArticleView({ post, related, comments: initialComments, slug, business }: { post: Post; related?: ArticleCardPost[]; comments: Comment[]; slug: string; business?: Business }) {
