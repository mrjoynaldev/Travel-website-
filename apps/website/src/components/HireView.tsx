...
export default function HireView() {
  ...
  return <>
    ...
    <section id="contact" className="container py-12 md:py-16"><p className="font-label text-xs text-primary">Contact</p><h2 className="mt-2 font-display text-3xl font-semibold">Tell me what you need</h2><p className="mt-2 max-w-xl text-sm text-muted-foreground">Reply within 12h. Or reach directly: <a href="mailto:editor@codereportglobal.com" className="text-primary underline">editor@codereportglobal.com</a> · WhatsApp on request.</p>
